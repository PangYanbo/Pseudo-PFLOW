...
public class DrmExample01 {
    public static void main(String[] args) throws IOException {
        File inputFile = new File(args[1]);
        long ts00 = System.nanoTime();
        Network network = new CsvDrmAllRoadLoader().setNetworkFile(new File(args[0])).setDelimiter(ICsvNetworkLoader.Delimiter.TSV).setHeaderFlag(true).setGeometryFlag(true).load();
