...
extends Link {
    private static final long serialVersionUID = -3494960378150534775L;
    ...
    public DrmLink(String linkid, Node tailNode, Node headNode, double length, double cost, double revCost, boolean oneway, int roadtype, int width, int laneNum, List<LonLat> geom) {
