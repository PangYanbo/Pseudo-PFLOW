...
extends ACsvNetworkLoader {
    ...
    public CsvSeiDrmLoader(File networkfile, ACsvNetworkLoader.Delimiter delimiter) {
    ...
    protected Link parseLine(Network network, String line, boolean needGeom) {
        ...
        return new DrmLink(String.valueOf(gid), n0, n1, length, cst, rcst, way, type, width, lanes, list);
    }
